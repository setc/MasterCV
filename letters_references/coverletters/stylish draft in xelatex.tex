...
\setkomavar{fromname}{Sebasti\'an Torrente} % Your name
\setkomavar{fromaddress}{43 Longridge House\\Falmouth Road\\SE1 6QW London} % Your address
\setkomavar{fromphone}{(07423) 632 073} % Your phone number
...
\firsthead{
\centering
{\addfontfeature{LetterSpace=20.0}\fontsize{30}{30}\selectfont\scshape \usekomavar{fromname}}\\[4mm]
\fontsize{21}{21}\selectfont\scshape Physics MS } % Your current job title
