...
\section{Profile}
\cvitem{}{
I am a Physics graduate always in search of knowledge and challenges and with a 
strong interest in programming. With my degree finished my next goal is to participate
 in interesting projects to help them succeed and further develope my programming
 skills. I offer an inquisitive and perseverant mind, happy to share his knowledge 
...
\cvitemwithcomment{Other}
	{C, R, MATLAB(Octave)}
	{I also wanto to add Haskell to the list}
...
\cvitem{Availability}{I will be available on January}
