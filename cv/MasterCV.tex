...
%
%	1.3 Milkroundabout Special Edition:
%		So the Milkroundabout is here! So it's time to update my CV with new skills
%		If by any chance you came to this repository from the Milkroudabout, hi!
%		And thanks for looking at my Github account.
%
%----------------------------------------------------------------------------------%
%   Index																	[Ind]  %
%----------------------------------------------------------------------------------%
...
\address{211 Abbott Road}{E14 0NE Poplar, London}
...
\section{Profile}
\cvitem{}{
Physics graduate with work experience as analyst, always in search of knowledge and challenges and with a strong interest in programming. My goal is to help develop interesting projects, to make them succeed and improve my programming skills while learning new ones. I offer an inquisitive and perseverant mind, happy to share his knowledge and lend a hand when needed.
}
...
\cventry{2001-2013}
	...
	\begin{itemize}
		...
		\item Volunteered to compile, manage, edit and typeset in \LaTeX\ the 			
		compilation book with all the papers wrote for the Nuclear Physics class, 	
		which was published.
...
\cventry{2013--Present}
	...
	{London}
	{}
	{Entered as an Intern for a month in May and I am currently working as Data
	 Analyst.
	\begin{itemize}
		\item Key contributions in two important pilot project.
		\item Further refined my skills in Python and MySQL, using the former to 
		parse XML, JSON and interact with a RESTful API.
	\end{itemize}}
...
\begin{itemize}
	...
	that \textit{Edge Entertainment} gave us full control (and responsibility) 
	over all the project and the final say on every aspect.
...
\cvitemwithcomment{Databases}
	{MySQL, SQLite}
	{}

\cvitemwithcomment{VCS}
	{Git, Github}
...
\cvitemwithcomment{Other}
	{C, R, MATLAB(Octave)}
	{I am planning to add Haskell to the list}
	
\cvitemwithcomment{Tools}
	{Jira and Confluence, Vim, MySQL Workbench}
	{}
...
\cvitem{Learning}
	{Developing new skills is what motivates  me. I dedicate time 
	everyday to study even if my skills are enough at that moment. 
...
\cvitem{Hobbies}
	{Taking online and summer courses, travel, cooking, organising science fiction 	
	and martial arts cinema sessions, read, trade and discuss comics and novels and 
	make small fighting game tournaments with friends.}
...
\cvitem{Availability}{From February onwards}

\cvitem{Relocating}{Free to relocate}
