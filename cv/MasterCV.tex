...
can develop (and hone!) a wide set of skills, mainly programming and data analysis. 
I offer an inquisitive and perserverant mind, happy to share his knowledge and lend 
 a hand when needed.
}
...
\cventry{2001-2013}
	...
	to get more experience with \LaTeX. It was also an excellent opportunity to 
	organise and set in common the 'legacy code' essays of all my class into a single
	 book with an 	unified style.
	\item 
		\begin{itemize}
			\item Material
		\end{itemize}
